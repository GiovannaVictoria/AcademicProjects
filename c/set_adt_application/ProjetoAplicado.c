...
*           - criar um conjunto vazio (inicializar uma turma no sistema)                                                                            *
*           - inserir um conjunto completo (inserir uma turma completa no sistema)                                                                  *
*           - remover um conjunto completo (fechar uma turma no sistema)                                                                            *
*           - imprimir todos os RAs de um conjunto                                                                                                  *
*           - imprimir todos os RAs de um conjunto em ordem aleatoria                                                                               *
*           - imprimir todos os conjuntos atuais do programa (todos os RAs de todas as turmas)                                                      *
*           - verificar se um conjunto é vazio (se a turma esta vazia)                                                                              *
*           - verificar se um conjunto está no tamanho máximo suportado pelo programa (se a turma esta cheia)                                       *
*           - verificar o tamanho de um conjunto (o numero de RAs de uma turma)                                                                     *
*           - verificar se um conjunto contem um RA especifico                                                                                      *
...
*           - inserir um RA em um conjunto (inserir um RA na turma)                                                                                 *
*           - pegar um RA aleatorio de um conjunto                                                                                                  *
*           - obter o RA de valor mais proximo de um dado valor de referencia                                                                       *
*           - remover um RA de um conjunto (trancar a matricula de um aluno)                                                                        *
*           - remover todos os RAs de um conjunto (limpar a turma)                                                                                  *
*           - obter o RA de menor valor de um conjunto.                                                                                             *
*           - obter o RA de maior valor de um conjunto.                                                                                             *
*           - obter o valor da soma de todos os RAs de um conjunto.                                                                                 *
*           - imprimir o menu                                                                                                                       *
*                                                                                                                                                   *
* Data de criacao: 27/08/2022                                                                                                                       *
* Data da ultima alteracao: 30/09/2022                                                                                                              *
*                                                                                                                                                   *
\* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
int main () {
    ...
    qtd = 0;
    printf("Bem-vindo! Este programa trabalha com conjuntos de RAs de alunos da UFSCar, e possui as seguintes funcionalidades:\n");
    imprimeMenu();
...
void ajuda (int operacao) {
    ...
    switch (operacao) {
        ...
        case 2:
            ...
            printf("inserir o tamanho (n) do conjunto e, depois, os n RAs de alunos que farao parte do conjunto.\n");
        ...
        case 4:
            ...
            printf("Em seguida, o programa imprimira o tamanho do conjunto, todos os RAs dos alunos nele contido e seu indice.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 5:
            printf("O usuario deve escolher um conjunto para que os RAs dos alunos nele contido sejam impressos em ordem aleatoria, ou seja: \n");
            printf("escolher o numero referente ao indice do conjunto (a ordem em que foram inseridos no programa).\n");
            printf("O programa verificara se é possivel imprimir os RAs, ou seja: ");
            printf("se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Em seguida, o programa imprimira os RAs de todos os alunos do conjunto em ordem aleatoria.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 6:
        ...
        case 8:
            ...
            break;
        case 9:
            printf("O usuario deve escolher um conjunto para ser verificado a quantidade de alunos nele contido, ou seja: ");
            printf("escolher o numero referente ao indice do conjunto (a ordem em que foram inseridos no programa).\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Em seguida, o programa informara o a quantidade de alunos contidos no conjunto. Apos isso, sera oferecida ao usuario a possibilidade de ver o conjunto impresso.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 10:
            printf("O usuario deve escolher o RA de um aluno e um conjunto A para verificar se o aluno pertence a A, ou seja: ");
            printf("inserir o numero do conjunto escolhido e, depois, o RA escolhido.\n");
            ...
            printf("Em seguida, o programa informara se o RA esta contido no conjunto escolhido ou nao. Caso esteja, sera informada a posicao do aluno no conjunto.\n");
            printf("Apos isso, sera oferecida ao usuario a possibilidade de ver o conjunto impresso.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 11:
            printf("O usuario deve escolher dois conjuntos, A e B, para obter um novo conjunto resultante da diferenca entre eles;\n");
            printf("A diferenca entre dois conjuntos A - B é dada pelos RAs dos alunos que estao contidos em A e nao estao contidos em B.\n");
            ...
            printf("Ademais, o programa verificara se os numeros escolhidos para os conjuntos sao indices validos. Caso nao sejam, o usuario deve digitar numeros validos.\n");
        ...
        case 12:
            ...
            printf("A interseccao entre dois conjuntos A e B é dada pelos RAs dos alunos que estao contidos em A e em B ao mesmo tempo.\n");
            printf("Portanto, o usuario deve escolher os numeros dos dois conjuntos escolhidos para A e B, nessa ordem.\n");
            printf("O programa verificara se ha, pelo menos, 2 conjuntos inseridos no programa. Caso nao haja, ele informara.\n");
        ...
        case 13:
            ...
            printf("A uniao entre dois conjuntos A e B é dada pelos RAs dos alunos que estao contidos em A ou em B.\n");
            printf("Portanto, o usuario deve escolher os numeros dos dois conjuntos escolhidos para A e B, nessa ordem.\n");
            printf("O programa verificara se ha, pelo menos, 2 conjuntos inseridos no programa. Caso nao haja, ele informara.\n");
            printf("Ademais, o programa verificara se os numeros escolhidos para os conjuntos sao indices validos. Caso nao sejam, o usuario deve digitar numeros validos.\n");
            printf("Em seguida, o programa imprimira os dois conjuntos escolhidos e o conjunto resultante.\n");
        ...
        case 14:
            ...
            printf("Dois conjuntos A - B sao iguais se, e somente se, todos os RAs dos alunos de A estao contidos em B, e vice-versa.\n");
            printf("Portanto, o usuario deve escolher os numeros dos dois conjuntos escolhidos para A e B, nessa ordem.\n");
            printf("O programa verificara se ha, pelo menos, 2 conjuntos inseridos no programa. Caso nao haja, ele informara.\n");
            printf("Ademais, o programa verificara se os numero escolhidos para os conjuntos sao indices validos. Caso nao sejam, o usuario deve digitar numeros validos.\n");
        ...
        case 15:
            ...
            printf("Um conjunto A é um subconjunto de B se, e somente se, todos os RAs dos alunos de A estao contidos em B.\n");
            printf("Portanto, o usuario deve escolher os numeros dos dois conjuntos escolhidos para A e B, nessa ordem.\n");
            printf("O programa verificara se ha, pelo menos, 2 conjuntos inseridos no programa. Caso nao haja, ele informara.\n");
            printf("Ademais, o programa verificara se os numero escolhidos para os conjuntos sao indices validos. Caso nao sejam, o usuario deve digitar numeros validos.\n");
            ...
            break;
        case 16:
            printf("O usuario deve inserir um RA e um conjunto para o RA ser inserido no conjunto, ou seja: ");
            printf("escolher o numero do conjunto e, depois, o RA do aluno, que sera inserido.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Ademais, o programa verificara se é possivel inserir o RA no conjunto, ou seja: ");
            printf("se o conjunto esta com o numero maximo de alunos (%d), ou se o conjunto ja contem o aluno com o RA inserido.\n", tam_max_elementos);
            printf("Em seguida, o programa informara se foi possivel fazer a insercao, e o motivo caso nao tenha sido.\n");
            printf("Apos isso, sera oferecida ao usuario a possibilidade de ver o conjunto impresso.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 17:
            printf("O usuario deve escolher um conjunto para ser pegado um RA aleatorio, ou seja: ");
            printf("escolher o numero do conjunto.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Ademais, o programa verificara se é possivel pegar um RA do conjunto, ou seja: se o conjunto esta vazio.\n");
            printf("Em seguida, o programa informara se foi possivel fazer a remocao, e o motivo caso nao tenha sido.\n");
            printf("Apos isso, o programa imprimira o RA do aluno escolhido.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 18:
            printf("O usuario deve escolher um conjunto e um valor inteiro para ser procurado o RA de valor mais proximo a esse valor, ou seja: ");
            printf("escolher o numero do conjunto e, depois, o valor que sera usado como referencia na busca.\n");
            printf("O programa verificara se o numero escolhido para o conjunto é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Ademais, o programa verificara se é possivel buscar RAs de alunos no conjunto, ou seja: se o conjunto esta vazio.\n");
            printf("Se estiver, o programa informara. Senao, o programa imprimira o RA de valor mais proximo ao valor escolhido como referencia, e sua posicao no conjunto.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 19:
            printf("O usuario deve escolher um RA e um conjunto para o RA ser removido do conjunto de alunos, ou seja: ");
            printf("escolher o numero do conjunto e, depois, o RA do aluno que sera removido.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("Ademais, o programa verificara se é possivel remover o aluno do conjunto, ou seja: ");
            printf("se o conjunto esta vazio, ou se o conjunto nao contem o aluno com o RA escolhido.\n");
            printf("Em seguida, o programa informara se foi possivel fazer a remocao, e o motivo caso nao tenha sido.\n");
            printf("Apos isso, sera oferecida ao usuario a possibilidade de ver o conjunto impresso.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 20:
            printf("O usuario deve escolher um conjunto para serem removidos todos os RAs de alunos nele contido, ou seja: escolher o numero do conjunto.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("O programa verificara se o conjunto esta vazio.\n");
            printf("Se estiver, o programa informara. Senao, serao removidos todos os alunos e seus RAs do conjunto escolhido.\n");
            printf("Caso haja alguma duvida quanto ao numero de cada conjunto, a operacao #4 imprime todos os conjuntos atuais inseridos no programa e seus respectivos indices.\n");
            break;
        case 21:
            printf("O usuario deve escolher um conjunto para ser procurado seu RA de menor valor, ou seja: escolher o numero do conjunto.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("O programa verificara se o conjunto esta vazio ou nao.\n");
            printf("Se estiver, o programa informara. Senao, sera informado o RA de menor valor do conjunto escolhido.\n");
            break;
        case 22:
            printf("O usuario deve escolher um conjunto para ser procurado seu RA de maior valor, ou seja: escolher o numero do conjunto");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("O programa verificara se o conjunto esta vazio ou nao.\n");
            printf("Se estiver, o programa informara. Senao, sera informado o RA de maior valor do conjunto escolhido.\n");
            break;
        case 23:
            printf("O usuario deve escolher um conjunto para se obter a soma de todos os RAs nele contido, ou seja: escolher o numero do conjunto.\n");
            printf("O programa verificara se o numero escolhido é um indice valido. Caso nao seja, o usuario deve digitar um numero valido.\n");
            printf("O programa verificara se o conjunto esta vazio ou nao.\n");
            printf("Se estiver, o programa informara. Senao, sera informado o valor da soma de todos os RAs do conjunto escolhido.\n");
            break;
        case 24:
    ...
    switch (operacao) {
        ...
        case 4:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: imprimir todos os RAs dos alunos de um conjunto.\n");
        ...
        case 5:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: imprimir todos os RAs dos alunos de um conjunto em ordem aleatoria.\n");
                printf("Digite o numero do conjunto a ser impresso: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
        ...
        case 9:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: verificar o numero de RAs contidos em um conjunto.\n");
                printf("Digite o numero do conjunto a ser verificado: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
        ...
        case 10:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: verificar se um conjunto contem um RA especifico.\n");
                printf("Digite o numero do conjunto a ser verificado: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                printf("Digite o RA a ser verificado: ");
                scanf("%d", &elemento);
                // verifica se o elemento esta contido no conjunto
                existe = existeElemento(conjuntos[indice-1], elemento);
                if (existe==-1) {
                    printf("O RA %d nao esta contido no conjunto %d.\n", elemento, indice);
                } else {
                    // se estiver, mostra a posicao do elemento no vetor
                    printf("O RA %d esta contido no conjunto %d.\n", elemento, indice);
                    printf("A posicao do RA no conjunto é %d.\n", existe+1);
                }
                // da ao usuario a chance de ver o vetor impresso
                printf("Gostaria de imprimi-lo? (s/n): ");
                scanf(" %c", &escolha);
        ...
        case 13:
            ...
            if (*qtd<2) {
                ...
                if (resultado.tamanho==-1) {
                    printf("Nao é possivel realizar a operacao, pois a quantidade de RAs no conjunto resultante é maior que o tamanho maximo suportado pelo programa.\n");
                    printf("Escolha conjuntos menores, ou remova RAs de algum dos conjuntos, ou escolha outra operacao.\n");
                } else {
                    printf("Conjunto A:\n");
                    escreveConjunto(conjuntos[indiceA-1]);
                    printf("Conjunto B:\n");
        ...
        case 16:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: inserir o RA de um aluno em um conjunto.\n");
                ...
                if ( conjuntoMaximo(conjuntos[indice-1]) ) {
                    ...
                    printf("Remova RAs deste conjunto ou escolha outra operacao.\n");
                } else {
                    ...
                    if (sucesso) {
                        printf("RA inserido com sucesso no conjunto.\n");
                    } else {
                        printf("O RA nao foi inserido no conjunto pois ja esta contido nele.\n");
                    }
        ...
        case 17:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: pegar um RA aleatorio de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if (conjuntoVazio(conjuntos[indice-1])) {
                    ...
                    printf("O RA aleatorio escolhido foi: %d\n", elemento);
                }
            }
            break;
        case 18:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: encontrar o RA de valor mais proximo ao de um valor escolhido como referencia.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if (conjuntoVazio(conjuntos[indice-1])) {
                    ...
                    printf("O RA de valor mais proximo ao valor %d é: %d, e sua posicao no conjunto é %d.\n", busca, conjuntos[indice-1].vetor[elemento], elemento+1);
                }
            }
            break;
        case 19:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: remover um RA de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if ( conjuntoVazio(conjuntos[indice-1]) ) {
                    ...
                    if (sucesso) {
                        printf("RA removido com sucesso do conjunto.\n");
                    } else {
                        printf("O RA nao foi removido do conjunto pois nao estava contido nele.\n");
                    }
                    // da ao usuario a chance de ver o conjunto impresso
                    printf("Gostaria de imprimi-lo? (s/n): ");
                    scanf(" %c", &escolha);
        ...
        case 20:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: remover todos os RAs de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if ( conjuntoVazio(conjuntos[indice-1]) ) {
                    ...
                    printf("RAs removidos com sucesso.\n");
                }
            }
            break;
        case 21:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: obter o menor RA de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if (conjuntoVazio(conjuntos[indice-1])) {
                    ...
                    printf("O RA de menor valor do conjunto %d é: %d\n", indice, elemento);
                }
            }
            break;
        case 22:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: obter o maior RA de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if (conjuntoVazio(conjuntos[indice-1])) {
                    ...
                    printf("O RA de maior valor do conjunto %d é: %d\n", indice, elemento);
                }
            }
            break;
        case 23:
            ...
            if (*qtd==0) {
                ...
                printf("Operacao escolhida: obter o valor da soma de todos os RAs de um conjunto.\n");
                printf("Digite o numero do conjunto escolhido: ");
                scanf("%d", &indice);
                // verifica se o usuario escolheu um indice valido do vetor de conjuntos, e entra num loop ate o usuario digitar um numero valido
                while (indice>*qtd || indice<1) {
                ...
                if (conjuntoVazio(conjuntos[indice-1])) {
                    ...
                    printf("O valor da soma de todos os RAs do conjunto %d é: %lld\n", indice, soma);
                }
            }
            break;
        case 24:
...
void imprimeMenu (void) {
    ...
    printf("Importante! O programa suporta um conjunto de tamanho maximo de %d RAs, e um maximo de %d conjuntos.\n", tam_max_elementos, tam_max_conjuntos);
    printf("1 - criar um conjunto vazio\n");
    printf("2 - inserir um conjunto completo\n");
    printf("3 - remover um conjunto completo\n");
    printf("4 - imprimir todos os RAs de um conjunto\n");
    printf("5 - imprimir todos os RAs de um conjunto em ordem aleatoria\n");
    ...
    printf("10 - verificar se um conjunto contem um RA especifico\n");
    ...
    printf("16 - inserir um RA em um conjunto\n");
    printf("17 - pegar um RA aleatorio de um conjunto\n");
    printf("18 - obter o RA de valor mais proximo de um dado valor de referencia\n");
    printf("19 - remover um RA de um conjunto\n");
    printf("20 - remover todos os RAs de um conjunto\n");
    printf("21 - obter o RA de menor valor de um conjunto.\n");
    printf("22 - obter o RA de maior valor de um conjunto.\n");
    printf("23 - obter o valor da soma de todos os RAs de um conjunto.\n");
...
int lerConjunto (tConjunto conjuntos[], int *qtd) {
    ...
    printf("Digite os %d RAs do conjunto: ", conjuntos[*qtd].tamanho);

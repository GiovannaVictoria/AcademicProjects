...
<body>
	...
	<div align="center">
		<h3>
			<a
				href="${pageContext.request.contextPath}/consulta/listaConsultasPaciente?login=${usuarioLogado.login}"><fmt:message
	...
	<div align="center">
		<h3>
			<a
				href="${pageContext.request.contextPath}/consulta/cadastro?login=${usuarioLogado.login}"><fmt:message
					key="agendarConsulta" /></a>
		</h3>
	</div>
	<div align="center">
		<h4>

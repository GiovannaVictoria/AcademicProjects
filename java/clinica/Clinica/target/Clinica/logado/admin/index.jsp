...
<body>
	...
	<div align="center">
		<h1>
			<fmt:message key="paginaAdministrador" />
		</h1>
	</div>
	...
	<div align="center">
		<h3>
			<a href="${pageContext.request.contextPath}/medico/"><fmt:message
					key="administrarMedicos" /></a>
		</h3>
	</div>
	<div align="center">
		<h3>
			<a href="${pageContext.request.contextPath}/paciente/"><fmt:message
					key="administrarPacientes" /></a>
		</h3>
	</div>
	<div align="center">
		<h4>

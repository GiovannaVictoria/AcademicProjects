...
import ufscar.dc.compiladores.geradorLA.expressoesLABaseVisitor;
import ufscar.dc.compiladores.geradorLA.expressoesLAParser;
...
public class Analisador extends expressoesLABaseVisitor<String> {
            ...
            if (ctx.tipo_estendido() != null) {                                                                  // verifica se eh funcao
                escopoAtual.inserir(ctx.IDENT().getText(), ctx.IDENT().getText(), "funcao");                     // adiciona uma label identificando que eh funcao
                    if (ctx.tipo_estendido().tipo_basico_ident().tipo_basico() != null) {
                        if (ctx.tipo_estendido().getText().charAt(0) == '^') {
                            escolherTipo(escopoAtual, ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ctx.IDENT().getText(), "retorno", false, false, true);
                        } else {
                            escolherTipo(escopoAtual, ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ctx.IDENT().getText(), "retorno", false, false, false);
                        }
                    } else {
                ...
                for (expressoesLAParser.ParametroContext p : ps) {
                    ...
                    for (expressoesLAParser.IdentificadorContext i : ids) {
                        if (p.tipo_estendido().tipo_basico_ident().tipo_basico() != null) {
                            if (p.tipo_estendido().getText().charAt(0) == '^') {
                                escolherTipo(escopoAtual, p.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ctx.IDENT().getText(), i.IDENT(0).getText(), false, false, true);
                            } else {
                                escolherTipo(escopoAtual, p.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ctx.IDENT().getText(), i.IDENT(0).getText(), false, false, false);
                            }
    ...
    public String visitDeclaracao_local(expressoesLAParser.Declaracao_localContext ctx) {
        ...
        if (ctx.variavel() != null) {
            ...
            if (escopoAtual.existe(ctx.IDENT().getText())) {
                ...
                if (ctx.tipo() != null) {
                    myVisitTipoPersonalizado(ctx.tipo(), ctx.IDENT().getText());
                } else {
                    // declaracao de constante - apenas tipo basico
                    escolherTipo(escopoAtual, ctx.tipo_basico().getText(), ctx.IDENT().getText(), ctx.IDENT().getText(), false, false, false);
                }
            }
        }
    ...
    public String visitTipoNormal (expressoesLAParser.TipoContext t_ctx, expressoesLAParser.IdentificadorContext i_ctx) {
        ...
        if (t_ctx.tipo_estendido() != null) {
            if (t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico() != null) {
                if (t_ctx.tipo_estendido().getText().charAt(0) == '^') {
                    escolherTipo(escopoAtual, t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), i_ctx.IDENT(0).getText(), i_ctx.IDENT(0).getText(), false, false, true);
                } else {
                    escolherTipo(escopoAtual, t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), i_ctx.IDENT(0).getText(), i_ctx.IDENT(0).getText(), false, false, false);
                }
                ...
                if (escopoAtual.existe((t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()))) {
                    if (escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).nome.equals("registro")) {              // verificando se eh registro
                        ...
                        if (t_ctx.tipo_estendido().getText().charAt(0) == '^') {
                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, i_ctx.IDENT(0).getText(), i_ctx.IDENT(0).getText(), true, false, true)) {
                            ...
                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, i_ctx.IDENT(0).getText(), i_ctx.IDENT(0).getText(), true, false, false)) {
                                escopoAtual.inserir(i_ctx.IDENT(0).getText(), i_ctx.IDENT(0).getText(), "invalido");
                                UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");
                            }
                        }
                        ...
                        if (escopoAtual.existe(identificadores2.get(j).IDENT(0).getText())) {
                            ...
                            if (variaveis.get(i).tipo().tipo_estendido() != null) {
                                ...
                                if (variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico() != null) { // a variavel dentro do registro eh do tipo basico
                                    if (variaveis.get(i).tipo().tipo_estendido().getText().charAt(0) == '^') {
                                        escolherTipo(escopoAtual, variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico().getText(), i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), false, false, true);
                                    } else {
                                        escolherTipo(escopoAtual, variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico().getText(), i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), false, false, false);
                                    }
                                    ...
                                    if (escopoAtual.existe((variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()))) {
                                        if (variaveis.get(i).tipo().tipo_estendido().getText().charAt(0) == '^') {
                                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), true, false, true)) {
                                                escopoAtual.inserir(i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), "invalido");
                                                UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                                            }
                                        } else {
                                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), true, false, false)) {
                                                escopoAtual.inserir(i_ctx.IDENT(0).getText(), identificadores2.get(j).IDENT(0).getText(), "invalido");
                                                UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                                            }
                                        }
    ...
    // especificacao de um visitor modificado de tipo
    // declara tipos personalizados e bases de registros
    // recebe a mais o nome do tipo a ser declarado
    // nao ha retorno
    public String myVisitTipoPersonalizado (expressoesLAParser.TipoContext t_ctx, String ident) {
        TabelaSimbolos escopoAtual = escoposAninhados.obterEscopoAtual();
        if (t_ctx.tipo_estendido() != null) {
            if (t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico() != null) {            // declarando um tipo IDENT direto de um tipo basico
                if (t_ctx.tipo_estendido().getText().charAt(0) == '^') {
                    escolherTipo(escopoAtual, t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ident, ident, false, true, true);
                } else {
                    escolherTipo(escopoAtual, t_ctx.tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ident, ident, false, true, false);
                }
            } else {                                                                           // declarando um tipo IDENT a partir de outro tipo IDENT
                if (escopoAtual.existe((t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()))) {
                    if (t_ctx.tipo_estendido().getText().charAt(0) == '^') {
                        if (!escolherTipo(escopoAtual, escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, ident, ident, true, true, true)) {
                            escopoAtual.inserir(ident, ident, "invalido");
                            UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                        }
                    } else {
                        if (!escolherTipo(escopoAtual, escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, ident, ident, true, true, false)) {
                            escopoAtual.inserir(ident, ident, "invalido");
                            UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                        }
                    }
                        ...
                        if (escopoAtual.existe(identificadores2.get(j).IDENT(0).getText())) {
                            ...
                            if (variaveis.get(i).tipo().tipo_estendido() != null) {
                                ...
                                if (variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico() != null) { // a variavel dentro do registro sera declarada de um tipo basico
                                    if (variaveis.get(i).tipo().tipo_estendido().getText().charAt(0) == '^') {
                                        escolherTipo(escopoAtual, variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ident, identificadores2.get(j).IDENT(0).getText(), false, true, true);
                                    } else {
                                        escolherTipo(escopoAtual, variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().tipo_basico().getText(), ident, identificadores2.get(j).IDENT(0).getText(), false, true, false);
                                    }
                                } else { // a variavel dentro do registro sera declarada de um tipo IDENT
                                    if (escopoAtual.existe((variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()))) {
                                        if (variaveis.get(i).tipo().tipo_estendido().getText().charAt(0) == '^') {
                                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, ident, identificadores2.get(j).IDENT(0).getText(), true, true, true)) {
                                                escopoAtual.inserir(ident, identificadores2.get(j).IDENT(0).getText(), "invalido");
                                                UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                                            }
                                        } else {
                                            if (!escolherTipo(escopoAtual, escopoAtual.verificar(variaveis.get(i).tipo().tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo, ident, identificadores2.get(j).IDENT(0).getText(), true, true, false)) {
                                                escopoAtual.inserir(ident, identificadores2.get(j).IDENT(0).getText(), "invalido");
                                                UtilsLA.adicionarErroSemantico(t_ctx.tipo_estendido().tipo_basico_ident().start, "tipo " + escopoAtual.verificar(t_ctx.tipo_estendido().tipo_basico_ident().IDENT().getText()).get(0).tipo + " nao declarado\n");    
                                            }
                                        }
    ...
    public String visitParcela_unario (expressoesLAParser.Parcela_unarioContext ctx) {
        ...
        if (ctx.identificador() != null) {
            if (!escopoAtual.existe((ctx.identificador().IDENT(0).getText()))) {
              ...
              myVisitChamadaGenerico(ctx.IDENT().getText(), ctx.expressao());
        }
        return "ok";
    }
    ...
    public String visitCmdAtribuicao (expressoesLAParser.CmdAtribuicaoContext ctx) {
        ...
        if (!escopoAtual.existe(ctx.identificador().IDENT(0).getText())) {
            ...
            if (retorno.equals("erro")) {     // se houve algum erro no meio da expressao a ser atribuida, a atribuicao eh invalida
                UtilsLA.adicionarErroSemantico(ctx.identificador().start, "atribuicao1 nao compativel para " + ctx.identificador().getText() + "\n");
                ...
                if (nroIdentificadores > 1) { // se eh o campo de um registro e seu tipo for diferente do tipo da variavel sendo atribuida, a atribuicao eh invalida, com excecao de real <- inteiro
                    if (escopoAtual.verificar(ctx.identificador().IDENT(0).getText()).size() > 1) {
                        int nroVariaveis = ctx.identificador().IDENT().size();
                        if (!retorno.equals(escopoAtual.identificaTipo(escopoAtual.verificar(ctx.identificador().IDENT(0).getText()), ctx.identificador().IDENT(nroVariaveis-1).getText()))) {
                            if (!retorno.equals("inteiro") || !escopoAtual.identificaTipo(escopoAtual.verificar(ctx.identificador().IDENT(0).getText()), ctx.identificador().IDENT(nroVariaveis-1).getText()).equals("real")) {
                                UtilsLA.adicionarErroSemantico(ctx.identificador().start, "atribuicao2 nao compativel para " + ctx.identificador().getText() + "\n");
                            }
                        }
                    }
                    ...
                    if (!retorno.equals("inteiro") || !escopoAtual.verificar(ctx.identificador().IDENT(0).getText()).get(0).tipo.equals("real")) {
                        String tipo = escopoAtual.verificar(ctx.identificador().IDENT(0).getText()).get(0).tipo;
                        String atribuicao = ctx.getText();
                        if  ( !( (retorno.equals("inteiro") && tipo.equals("p_inteiro")) || (retorno.equals("p_inteiro") && tipo.equals("inteiro")) ||
                                     (retorno.equals("real")    && tipo.equals("p_real"))    || (retorno.equals("p_real")    && tipo.equals("real"))    ||
                                     (retorno.equals("literal") && tipo.equals("p_literal")) || (retorno.equals("p_literal") && tipo.equals("literal")) ||
                                     (retorno.equals("logico")  && tipo.equals("p_logico"))  || (retorno.equals("p_logico")  && tipo.equals("logico"))  )) {
                            if (atribuicao.charAt(0) == '^') { // verifica se eh ponteiro
                                UtilsLA.adicionarErroSemantico(ctx.identificador().start, "atribuicao3 nao compativel para ^" + ctx.identificador().getText() + "\n");
                            } else {
                                UtilsLA.adicionarErroSemantico(ctx.identificador().start, "atribuicao4 nao compativel para " + ctx.identificador().getText() + "\n");
                            }
                        }
                    }
                }
    ...
    // especificacao do visitor modificado de chamada
    // verifica se as chamadas de funcoes e procedimentos estao validas quanto ao numero e tipos dos parametros
    // recebe a mais o nome da funcao ou procedimento
    // nao ha retorno
    public String myVisitChamadaGenerico (String ident, List<expressoesLAParser.ExpressaoContext> expressoes) {
                    ...
                    if (pu != null) {
                        if (pu.identificador() != null) {
                            ...
                            if (!escopoAtual.existe(pu.IDENT().getText())) {
                                ...
                                myVisitChamadaGenerico(pu.IDENT().getText(), pu.expressao());
    ...
    // modularizacao do switch do tipo a ser declarado em qualquer tipo de declaracao
    // detecta o tipo especifico e insere a variavel na tabela de simbolos
    // parametros:
    //   - escopo: tabela de simbolos da analise
    //   - tipoTexto: tipo a ser inserido
    //   - ident1: nome do registro (se for variavel, eh o mesmo nome da variavel)
    //   - ident2: nome da variavel
    //   - ehTipo1: indica se o tipo que sera inserido eh originado de um tipo personalizado
    //   - ehTipo2: indica se o tipo a ser inserido sera considerado um tipo personalizado
    //   - ponteiro: indica se o tipo a ser inserido sera considerado um ponteiro
    // retorna true se deu certo e false caso contrario
    public boolean escolherTipo(TabelaSimbolos escopo, String tipoTexto, String ident1, String ident2, boolean ehTipo1, boolean ehTipo2, boolean ponteiro) {
        if (ponteiro) {
            if (ehTipo1) {
                switch (tipoTexto) {
                    case "t_inteiro":
                        escopo.inserir(ident1, ident2, "p_inteiro");
                        break;
                    case "t_real":
                        escopo.inserir(ident1, ident2, "p_real");
                        break;
                    case "t_logico":
                        escopo.inserir(ident1, ident2, "p_logico");
                        break;
                    case "t_literal":
                        escopo.inserir(ident1, ident2, "p_literal");
                        break;
                    default:
                        return false;
                }
